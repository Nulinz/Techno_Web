    ...
    <div class="container">
      <div class="row">
        <div class="banner-details">
          ...
          <p>Completed our projects with eminent value engineering principles and concepts</p>
        </div>
      </div>
    </div>
      ...
      <div class="row project-slider">
        <div class="col-lg-6">
          <div class="project-post">
            <figure>
              <img class="w-100" src="./assets/images/project/project_spre.png" alt="project-img-1">
            </figure>
            <div class="project-data">
              <h3><a href="javascript:void(0)">SPRE Vatrathunda - Mumbai</a></h3>
              <p>100 Lakhs</p>
        ...
        <div class="col-lg-6">
          <div class="project-post">
            <figure>
              <img class="w-100" src="./assets/images/project/project_casagrand.png" alt="project-img-2">
            </figure>
            <div class="project-data">
              <h3><a href="javascript:void(0)">Casagrand Zingo - Chennai</a></h3>
              <p>80 Lakhs</p>
              <!-- <a class="project-icon" href="#">
                <i class="fa-solid fa-angles-right"></i>
              </a> -->
        ...
        <div class="col-lg-6">
          <div class="project-post">
            <figure>
              <img class="w-100" src="./assets/images/project/project_sobha.png" alt="project-img-3">
            </figure>
            <div class="project-data">
        ...
        <div class="col-lg-6">
          <div class="project-post">
            <figure>
              <img class="w-100" src="./assets/images/project/project_caparo.png" alt="project-img-4">
            </figure>
            <div class="project-data">
              <h3><a href="javascript:void(0)">Caparo Powerhouse - Chennai</a></h3>
              <p>550 Lakhs</p>
              <!-- <a class="project-icon" href="#">
                <i class="fa-solid fa-angles-right"></i>
              </a> -->
