                ...
                <div class="about-us-content">
                    ...
                    <div class="section-title">
                        ...
                        <p class="wow fadeInUp" data-wow-delay="0.2s">Mr. Saravanan, the Founder & CEO, embodies the
                            ...
                            with elite educational backgrounds.</p>
                    </div>
                    <!-- Section Title End -->
                    ...
                    <div class="about-us-content-body">
                        ...
                        <div class="about-us-content-info">
                            ...
                            <div class="about-us-content-list wow fadeInUp" data-wow-delay="0.4s">
                                <ul>
                                    <li>Business Intelligence Experts, UT Austin</li>
                                    <li>Postgraduates in Construction Management</li>
                                    <li>Business Analysts from Great Lakes</li>
                                </ul>
                            </div>
                        ...
                        <div class="about-us-content-info">
                            ...
                            <div class="about-us-content-list wow fadeInUp" data-wow-delay="0.4s">
                                <ul>
                                    <li>Design Thinkers from Massachusetts</li>
                                    <li>Structural Designers from IIT</li>
                                </ul>
                            </div>
                            <!-- About Us Content List End -->
                        </div>
