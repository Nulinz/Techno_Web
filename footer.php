<footer class="footer-style-one">
                    ...
                    <div class="footer-col">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <p><a href="./terms_and_conditions.php" style="color: #b7b7b7;">Terms And Conditions</a></p>
                            </li>
                            <li>
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 384 512">
                                ...
                                <p><a href="./cancellation_policy.php" style="color: #b7b7b7;">Cancellation Policy</a></p>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="footer-p-3 rights">
        <div class="container">
            <div class="row">
                <div class="footer-col">
                    <p>Technomerates <i class="fa-solid fa-heart"></i> © 2023 | All rights reserved</p>
