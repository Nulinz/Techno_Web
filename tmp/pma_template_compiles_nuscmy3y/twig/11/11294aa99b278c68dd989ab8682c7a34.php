...
class __TwigTemplate_5a0c36fd006660292cd73879d2662d2d extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "database/structure/copy_form.twig", "/usr/local/cpanel/base/3rdparty/phpMyAdmin/templates/database/structure/copy_form.twig");
    }
}
